...
Widget registersuccess = Container(
  child: Text('basarili'),
);
Widget registernotsuccess = Container(
                          ...
                          try {
                            await FirebaseAuth.instance
                                .createUserWithEmailAndPassword(
                                    email: eposta, password: pass);
                            kullaniciolustur(mail: eposta, sifre: pass);
                            setState(() {
                              mybottom = registersuccess;
                            });
                          } catch (e) {
                            setState(() {
                              mybottom = registernotsuccess;
                              print('hata');
                            });
                          }
                        } else {}
...
Future olustur(String adres, String pass) async {
  await FirebaseAuth.instance
      .createUserWithEmailAndPassword(email: adres, password: pass);
}

Future kullaniciolustur({required String mail, required String sifre}) async {
